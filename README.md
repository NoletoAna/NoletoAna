...
Atualmente estou cursando o Ensino Técnico em __Análise e Desenvolvimento de Sistemas__ e utilizo essas tecnologias:<br>•	HTML<br>•	CSS<br>•	PHP<br>•	Framework Laravel PHP<br>•	Bootstrap
