...
Atualmente estou cursando o Ensino Técnico em Análise e Desenvolvimento de Sistema e uso essas tecnologias:<br>•	HTML<br>•	CSS<br>•	PHP<br>•	Framework Laravel PHP<br>•	Bootstrap<br>
